      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-4 rounded-lg border border-slate-200 bg-slate-50">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-slate-900">{analysis.predicted_bmd?.toFixed(3)}</span>
        ...
        <div className="p-4 rounded-lg border border-blue-200 bg-blue-50">
          ...
          <p className="text-sm text-slate-700 leading-relaxed">
            ...
            <strong className="text-slate-900">{analysis.osteoporosis_classification}</strong>.{' '}
            {analysis.osteoporosis_classification === 'normal' 
              ? 'Continue regular monitoring and maintain current lifestyle habits.'
              : analysis.osteoporosis_classification === 'osteopenia'
